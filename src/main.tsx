...
function App() {
  ...
  return <div className="app-shell">
    <header className="site-header"><a className="brand" href="https://everydayai.work" aria-label="Everyday AI home"><img src="/favicon.svg" alt="" width="28" height="28"/><span>everyday<span className="brand-ai">ai</span><span className="brand-divider">/</span><span className="brand-product">feelings</span></span></a><div className="header-right"><span className="header-note">A little space to check in.</span><div className="language-control"><label htmlFor="second-language">Also in</label><select id="second-language" value={secondLanguage} onChange={event => setSecondLanguage(event.target.value as 'hi' | 'es')} aria-label="Second language"><option value="hi">Hindi</option><option value="es">Spanish</option></select></div></div></header>
